...
def parse_args():
    ...
    args.add_argument("--batch_size", dest="batch_size", type=int, default=2)
    args.add_argument(
...
if __name__ == "__main__":
    ...
    ROOT_PATH = (
        ...
        "~/examensarbete/AI-deck/image_processing/classification/"
    )
    ...
    with open(
        f"{ROOT_PATH}/model/classification.tflite", "wb"
    ) as f:
        f.write(tflite_model)
